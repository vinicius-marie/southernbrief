  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid lg:grid-cols-3 gap-12">
            ...
            {[
              {
                ...
                excerpt:
                  "Representatives from multiple nations gather to address ongoing regional tensions.",
                time: "2 hours ago",
              },
              {
                title: "Humanitarian Crisis Deepens in Conflict Zones",
                excerpt:
                  "International organizations call for urgent assistance as conditions deteriorate.",
                time: "5 hours ago",
              },
              {
                title: "Trade Agreement Promises Economic Cooperation",
                excerpt:
                  "New pact aims to strengthen ties between developing economies.",
                time: "18 hours ago",
              },
              {
                title: "Cultural Festival Celebrates Global Diversity",
                excerpt:
                  "Major cities host events highlighting international heritage and traditions.",
                time: "1 day ago",
              },
            ].map((article, index) => (
            ...
            {[
              {
                ...
                excerpt:
                  "Economic policymakers adjust strategies in response to inflation data.",
                time: "4 hours ago",
              },
              {
                title: "Renewable Energy Sector Sees Record Investment",
                excerpt:
                  "Green technology companies attract unprecedented funding levels.",
                time: "7 hours ago",
              },
              {
                title: "Supply Chain Disruptions Ease Across Industries",
                excerpt:
                  "Manufacturing returns to normal operations after prolonged challenges.",
                time: "12 hours ago",
              },
              {
                title: "Startup Ecosystem Thrives Despite Economic Headwinds",
                excerpt:
                  "Innovation continues as entrepreneurs find new market opportunities.",
                time: "1 day ago",
              },
            ].map((article, index) => (
              <article key={index} className="group cursor-pointer">
        ...
        {/* Technology */}
        <div>
          <h3 className="mb-6 pb-3 border-b-2 border-neutral-900">
            Technology
          </h3>
          <div className="space-y-6">
            {[
              {
                ...
                excerpt:
                  "New defensive strategies emerge as digital attacks grow more sophisticated.",
                time: "3 hours ago",
              },
              {
                title: "Space Industry Launches New Communication Satellites",
                excerpt:
                  "Private companies expand global connectivity infrastructure.",
                time: "10 hours ago",
              },
              {
                title: "Software Updates Address Privacy Concerns",
                excerpt:
                  "Tech companies respond to user demands for greater data protection.",
                time: "15 hours ago",
              },
              {
                title: "Robotics Innovation Transforms Manufacturing",
                excerpt:
                  "Automated systems increase efficiency while creating new job categories.",
                time: "2 days ago",
              },
            ].map((article, index) => (
              <article key={index} className="group cursor-pointer">
